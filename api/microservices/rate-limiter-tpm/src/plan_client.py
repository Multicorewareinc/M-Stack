"""Best-effort lookup of an org's plan TPM limit from admin-control-plane (AD-04: rate
...
class PlanClient:
    ...
    async def get_tpm_limit(self, org_id: str) -> int | None:
        """The org's plan `tpm` (0 = plan says unlimited), or None if unknown/unreachable."""
        ...
        try:
            ...
            value: int | None = int(resp.json()["tpm"])
        except Exception:
            value = None
