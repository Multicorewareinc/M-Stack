...
Ported verbatim from Org CP SP-01 (AD-04 duplication-over-sharing). Uses argon2-cffi + bcrypt
directly (not passlib). Argon2id cost parameters come from Settings
