...
DECISIONS = Counter("rl_rpm_decisions_total", "RPM policy decisions", ["decision"])
CONSUMER_ACTIVE = Gauge("rl_rpm_consumer_active", "1 when the async counting consumer is bound, else 0")
