 ...
 * abbreviation is what PlansPage was built against. Anything else (not a
 * round thousand) falls back to a thousands-separated count rather than
 * guessing at a decimal abbreviation no call site expects. */
