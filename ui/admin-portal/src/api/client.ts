...
// (organizations.ts, plans.ts, ...), never this file or raw fetch directly.
...
/** Matches modules/auth/schemas.py's LoginResponse for admin-control-plane — org-less, no
 * permissions (super-admins are org-less; see that schema's own header comment). */
